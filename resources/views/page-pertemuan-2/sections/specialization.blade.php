...
@section('content')
    ...
    <div id="specialization_modal"
        ...
        <div class="p-10 bg-white rounded-lg shadow-lg max-w-3xl w-full">
            <form action="{{ route('specialization.add') }}" method="POST">
                @csrf
                <div class="relative z-0 w-full mb-5 group">
                    <input type="spesialisasi" name="spesialisasi" id="spesialisasi"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const modal = document.getElementById('specialization_modal');
